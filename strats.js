...
$(document).ready(function () {
    console.log("Document is ready. Populating strategy list...");

    let stratList = document.getElementById("strat-list");

    if (stratList) {
        stratList.innerHTML = '';

        strategies.forEach(strat => {
            const listItem = `<li title="${strat.description}">${strat.text}</li>`;
            stratList.innerHTML += listItem;
        });
        ...
        console.log("Strategy list populated successfully.");
    } else {
        console.error("The strategy list element does not exist in the DOM.");
    }
});
